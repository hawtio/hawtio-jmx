...
(function (Jmx) {
    Jmx._module.controller("Jmx.TreeHeaderController", ["$scope", function ($scope) {
            ...
            var search = _.debounce(function (filter) { return treeElement.treeview('search', [
                filter,
                {
                    ignoreCase: true,
                    exactMatch: false,
