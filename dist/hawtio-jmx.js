...
(function (Jmx) {
    ...
    Jmx._module.run(["$location", "workspace", "viewRegistry", "layoutTree", "jolokia", "helpRegistry", "pageTitle", function ($location, workspace, viewRegistry, layoutTree, jolokia, helpRegistry, pageTitle) {
...
var Jmx;
(function (Jmx) {
    Jmx._module.factory('jolokia', ["$location", "localStorage", "jolokiaStatus", "$rootScope", "userDetails", "jolokiaParams", "jolokiaUrl", function ($location, localStorage, jolokiaStatus, $rootScope, userDetails, jolokiaParams, jolokiaUrl) {
        ...
        Jmx.log.debug("Jolokia URL is " + jolokiaUrl);
        if (jolokiaUrl) {
...
(function (JVM) {
    JVM._module.controller("JVM.DiscoveryController", ["$scope", "localStorage", "jolokia", function ($scope, localStorage, jolokia) {
        ...
        $scope.fetch = function () {
            ...
            Core.$apply($scope);
            // use 30 sec timeout
            jolokia.execute('jolokia:type=Discovery', 'lookupAgentsWithTimeout(int)', 30 * 1000, Core.onSuccess(render));
        };
        $scope.fetch();
    }]);
})(JVM || (JVM = {}));
...
angular.module("hawtio-jmx-templates", []).run(["$templateCache", function($templateCache) {$templateCache.put("plugins/example/html/page1.html","<div class=\"row\">\n  <div class=\"col-md-12\" ng-controller=\"Example.Page1Controller\">\n    <h1>Page 1</h1>\n    <p>Hello {{target}}</p>\n  </div>\n</div>\n");
